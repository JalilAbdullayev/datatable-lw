                ...
                <div class="flex items-center justify-between d p-4">
                    <div class="flex">
                        <div class="relative w-full">
                            ...
                            <input type="search" placeholder="Search" required wire:model.live.debounce.300ms="search"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        @foreach($users as $user)
                            <tr class="border-b dark:border-gray-700" wire:key="{{ $user->id }}">
                                ...
                                <td @class(["px-4 py-3", 'text-green-500' => $user->is_admin, 'text-blue-500' => !$user->is_admin])>
                ...
                <div class="py-4 px-3">
                    <div class="flex ">
                        <div class="flex space-x-4 items-center mb-3">
                            <label class="w-32 text-sm font-medium text-gray-900 dark:text-gray-400">
                                Per Page
                            </label>
